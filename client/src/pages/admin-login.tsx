        ...
        <div className="p-6 pt-5">
          ...
          <div className="mt-6 text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <p className="text-[9px] font-black uppercase tracking-[0.3em] text-gray-400">or don't have an account?</p>
              <div className="h-px w-12 bg-gray-200" />
            </div>
            <Button
              onClick={() => setLocation('/register-tenant')}
              className="w-full h-12 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-2xl font-black uppercase tracking-[0.2em] hover:from-emerald-600 hover:to-teal-700 shadow-md shadow-emerald-500/20 transition-all"
            >
